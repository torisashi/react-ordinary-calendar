  ...
  _createClass(CalendarTr, [{
    ...
    value: function render() {
      ...
      for (var col = 0; col < 7; col++) {
        if (this.props.row == 0) {
          cells.push(_react2['default'].createElement(_CalendarTh2['default'], { key: col, val: this.state.vals.date[col], options: this.props.options }));
        } else {
          var data = {
          ...
          cells.push(_react2['default'].createElement(_CalendarTd2['default'], { key: col, val: data, options: this.props.options }));
        }
      }
      return _react2['default'].createElement(
        'tr',
        { style: this.props.options.defaultStyle ? _styleTableStyle2['default'].tr : {} },
        cells
      );
    }
  }]);
